  ...
  return (
    <div className="max-w-4xl mx-auto justify-center py-12 mt-3" id="tech">
      ...
      <div className="flex flex-wrap justify-center pt-2 mt-2">
        <div className="flex flex-col lg:w-44 lg:p-10 lg:m-6 md:w-44 md:p-5 md:m-6 w-32 p-3 m-3 overflow-hidden bg-white shadow-2xl rounded-xl hover:shadow-2xl hover:shadow-indigo-400">
        ...
        <div className="flex flex-col lg:w-44 lg:p-10 lg:m-6 md:w-44 md:p-5 md:m-6 w-32  p-3 m-3 overflow-hidden bg-white shadow-2xl rounded-xl hover:shadow-2xl hover:shadow-indigo-400">
          ...
          <p className="mt-6 text-xl font-semibold text-center">TailwindCSS</p>
        </div>

        <div className="flex flex-col lg:w-44 lg:p-10 lg:m-6 md:w-44 md:p-5 md:m-6 w-32  p-3 m-3 overflow-hidden bg-white shadow-2xl rounded-xl sm:w-52 hover:shadow-2xl hover:shadow-indigo-400">
